...
#                                                #
  ...
  if(data.type == "Original"){
    ...
    load(paste0(data.loc, "index/index_",methodology, ".", as.character(s), ".", as.character(ss), ".Rdata"))
  }else if(data.type == "Batch-corrected"){
    if(!dir.exists(paste0(data.loc, "AUROC_batch"))){
      dir.create(paste0(data.loc, "AUROC_batch"))
    }
    load(paste0(data.loc, "index_batch/index_",methodology, ".", as.character(s), ".", as.character(ss), ".Rdata"))
  }
