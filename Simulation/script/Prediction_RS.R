...
#                                                #
  ...
  if(data.type == "Original"){
    ...
    load(paste0(data.loc, "index_original/index_",methodology, ".", as.character(s),".Rdata"))
    ...
    load(paste0(data.loc, "index_batch_corrected/index_",methodology, ".", as.character(s),".Rdata"))
  }
