  ##############################################
#                                                #
#    Figure 2 (e2) Stability: K401 v.s. K849     #
#                                                #
  ##############################################
  ...
  data.loc.1 <- "./CRC_Real/CRC_loso_K849/"
  data.loc.2 <- "./CRC_Real/CRC_loso_K401/"
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models/Melody.model.all.Rdata")
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models/ANCOMBC.model.all.Rdata")
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models/Aldex2.model.all.Rdata")
      Aldex2.fdr <- Aldex2.model$glmfit$`labels1:pval.BH`
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models/BW.prop.model.all.Rdata")
    }else{
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models/CLR.lasso.model.all.Rdata")
    }else{
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models_batch/ANCOMBC.model.all.Rdata")
      ANCOMBC.rk.2[[k]] <- which(ANCOMBC.model$res$q_val$labels1[filters] <= fdr)
    }else{
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models_batch/Aldex2.model.all.Rdata")
      Aldex2.fdr <- Aldex2.model$glmfit$`labels1:pval.BH`
      Aldex2.rk.2[[k]] <- which((Aldex2.fdr)[filters] <= fdr)
    }else{
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models_batch/BW.prop.model.all.Rdata")
    }else{
  ...
  for(l in replicates){
    if(l == "all"){
      load("./CRC_Real/CRC_all_K849/Models_batch/CLR.lasso.model.all.Rdata")
    }else{
  ...
  pdf("./figures/figure2_e2.pdf",         # File name
