...
#                                                #
  ...
  rm(list = ls())
  # Load models
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.ref1.Rdata")
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.ref2.Rdata")
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.ref3.Rdata")
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.ref4.Rdata")
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.ref5.Rdata")
  load("./CRC_Real/CRC_all_K401/sensitivity/Melody.model.mixref.Rdata")
