...
# =============================================== #
  ...
  p11 <- PRC_all %>%
    ...
    xlab(TeX('$\\Delta$', bold = TRUE)) + ylim(0.48,0.9) +
  ...
  p12 <-  PRC_all %>%
    ggplot(aes(x=x.label, y=AUPRC, group = interaction(Method, batch_type), linetype = batch_type))  +
    xlab(TeX("d", italic = TRUE)) + ylim(0.48,0.9) +
    geom_line(linewidth = 0.7, aes(color=Method)) + geom_point(size = 2,aes(color = Method), pch = 18) +
    scale_color_manual(
      breaks =  c("Melody", "MMUPHin", "ANCOM-BC2"),
      values = c("red","purple","blue"))  +
  ...
  p13 <- PRC_all %>%
    ggplot(aes(x=x.label, y=AUPRC, group = interaction(Method, batch_type), linetype = batch_type))  +
    xlab(TeX("pos%", italic = TRUE)) + ylim(0.48,0.9) +
    geom_line(linewidth = 0.7, aes(color=Method)) + geom_point(size = 2,aes(color = Method), pch = 18) +
    scale_color_manual(
      breaks =  c("Melody", "MMUPHin", "ANCOM-BC2"),
      values = c("red","purple","blue"))  +
  ...
  p14 <- PRC_all %>%
    ggplot(aes(x=x.label, y=AUPRC, group = interaction(Method, batch_type), linetype = batch_type))  +
    xlab(TeX('u', italic = TRUE)) + ylim(0.48,0.9)+
    geom_line(linewidth = 0.7, aes(color=Method)) + geom_point(size = 2, aes(color = Method), pch = 18) +
    scale_color_manual(
      breaks =  c("Melody", "MMUPHin", "ANCOM-BC2"),
      values = c("red","purple","blue"))  +
  ...
  pdf("./figures/FigS3.pdf", width = 15, height = 7.5, bg = "white")
