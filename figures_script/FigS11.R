...
# =============================================== #
  ...
  pdf("./figures/FigS11_melody_bf.pdf", width = 6.75, height = 5.10, bg = "white")

  p_melody[[1]]

  dev.off()

  pdf("./figures/FigS11_melody_af.pdf", width = 6.75, height = 5.10, bg = "white")
  ...
  pdf("./figures/FigS11_mmuphin_bf.pdf", width = 6.75, height = 5.10, bg = "white")

  p_mmuphin[[1]]

  dev.off()

  pdf("./figures/FigS11_mmphin_af.pdf", width = 6.75, height = 5.10, bg = "white")
