...
#                                                #
  ...
  for(s in 1:100){
    ...
    save(index, file = paste0(data.loc, "index_original/index_Melody." , as.character(s),".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_original/index_Aldex2.", as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_original/index_ANCOM.",as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_original/index_BW.", as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_original/index_clrlasso.", as.character(s) ,".Rdata"))
  }
  ...
  for(s in 1:100){
    ...
    save(index, file = paste0(data.loc, "index_batch_corrected/index_Aldex2.", as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_batch_corrected/index_ANCOM.",as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_batch_corrected/index_BW.", as.character(s) ,".Rdata"))
    ...
    names(index) <- as.character(taxa.num)
    save(index, file = paste0(data.loc, "index_batch_corrected/index_clrlasso.", as.character(s) ,".Rdata"))
  }
