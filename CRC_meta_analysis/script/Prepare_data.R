...
# =============================================== #
  ...
  data.loc <- "./CRC_meta_analysis/"
  source("./utility/rarify.R")
  if(!dir.exists(paste0(data.loc, "CRC_all_K849/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_all_K849/prepare_data"))
  }
  if(!dir.exists(paste0(data.loc, "CRC_all_K401/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_all_K401/prepare_data"))
  }
  if(!dir.exists(paste0(data.loc, "CRC_all_order/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_all_order/prepare_data"))
  }
  if(!dir.exists(paste0(data.loc, "CRC_loso_K849/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_loso_K849/prepare_data"))
  }
  if(!dir.exists(paste0(data.loc, "CRC_loso_K401/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_loso_K401/prepare_data"))
  }
  if(!dir.exists(paste0(data.loc, "CRC_loso_order/prepare_data"))){
    dir.create(paste0(data.loc, "CRC_loso_order/prepare_data"))
  }
  ...
  # prepare data ----
  load(paste0(data.loc, "data/count.Rdata"))
  load(paste0(data.loc, "data/meta.Rdata"))
  load(paste0(data.loc, "data/tax.Rdata"))
  ...
  save(data.rel, file = paste0(data.loc, "CRC_all_K849/prepare_data/data.rel.all.Rdata"))
  save(data.rel.batch, file = paste0(data.loc,  "CRC_all_K849/prepare_data/data.rel.batch.all.Rdata"))
  ...
  for(l in 1:length(study)){
    ...
    save(data.rel, file = paste0(data.loc, "CRC_loso_K849/prepare_data/data.rel.",
                                 as.character(l), ".Rdata"))
    save(data.rel.batch, file = paste0(data.loc,  "CRC_loso_K849/prepare_data/data.rel.batch.",
                                       as.character(l), ".Rdata"))
  } 
  ...
  save(data.rel, file = paste0(data.loc, "CRC_all_K401/prepare_data/data.rel.all.Rdata"))
  save(data.rel.batch, file = paste0(data.loc,  "CRC_all_K401/prepare_data/data.rel.batch.all.Rdata"))
  ...
  for(l in 1:length(study)){
    data.rel <- tmp.data[-l]
    data.rel.batch <- tmp.data.batch[-l]
    save(data.rel, file = paste0(data.loc, "CRC_loso_K401/prepare_data/data.rel.",
                                 as.character(l), ".Rdata"))
    save(data.rel.batch, file = paste0(data.loc,  "CRC_loso_K401/prepare_data/data.rel.batch.",
                                       as.character(l), ".Rdata"))
  }
  ...
  save(data.rel, file = paste0(data.loc, "CRC_all_order/prepare_data/data.rel.all.Rdata"))
  save(data.rel.batch, file = paste0(data.loc,  "CRC_all_order/prepare_data/data.rel.batch.all.Rdata"))
  ...
  for(l in 1:length(study)){
    data.rel <- tmp.data[-l]
    data.rel.batch <- tmp.data.batch[-l]
    save(data.rel, file = paste0(data.loc, "CRC_loso_order/prepare_data/data.rel.",
                                 as.character(l), ".Rdata"))
    save(data.rel.batch, file = paste0(data.loc,  "CRC_loso_order/prepare_data/data.rel.batch.",
                                       as.character(l), ".Rdata"))
  }
